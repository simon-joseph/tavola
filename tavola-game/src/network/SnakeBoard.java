...
public final class SnakeBoard implements IBoard {
    ...
    private volatile Direction snakeDirectionForServer;
	...
	snakeDirectionForServer = Direction.RIGHT;
    ...
    public synchronized void setSnakeDirection(Direction direction) {
    ...
    public synchronized void setSnakeDirectionForServer(Direction direction) {
	if (!snakeDirectionForServer.opposite(direction)) {
	    snakeDirectionForServer = direction;
	}
    }

    public synchronized Direction getSnakeDirectionForServer() {
	return snakeDirectionForServer;
    }
